<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Settings / Auth Dropdown or Guest Links -->
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="text-sm font-medium text-amber-600 hover:text-amber-700">Đăng ký</a>
                    </div>
                @endauth
            </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="px-4 py-2 space-y-2">
                    <a href="{{ route('login') }}" class="block text-sm font-medium text-gray-600 hover:text-gray-900">Đăng nhập</a>
                    <a href="{{ route('register') }}" class="block text-sm font-medium text-amber-600 hover:text-amber-700">Đăng ký</a>
                </div>
            @endauth
        </div>
    </div>
